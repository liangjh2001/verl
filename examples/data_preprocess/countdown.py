...
<think>"""
        ...
        print("using qwen-instruct template")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='/data/liangjh/verl/data/countdown_qwen_instruct_new')
    ...
    parser.add_argument('--template_type', type=str, default='chat_template')
    ...
    raw_dataset = load_dataset("parquet",data_files='/data/liangjh/model_set/datasets/countdown/train-00000-of-00001.parquet', split='train')
